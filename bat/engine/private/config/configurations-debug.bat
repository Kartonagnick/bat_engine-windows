...
:addPrefixTo
    ...
    if not defined conf_values (
        @echo [WARNING] empty 'input name'
        @echo [WARNING] see 'output name' : %~3
        exit /b
    ) 
