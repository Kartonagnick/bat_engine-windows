...
rem    find_version --help

  rem options --min-version/--max-version must be ignored
    call :checkTest ^
    "001-test\long-000\workspace\external\gmock\ver-1.8.2" ^
        "--names: gmock; gtest"                  ^
        "--start:%list%"                  ^
  ...
  rem concrete
    call :checkTest ^
    "001-test\long-000\workspace\external\gmock\ver-1.8.3" ^
        "--names: gmock; gtest"           ^
        "--start:%list%"                  ^
        "--s: workspace*;external*;long*" ^
        "--version: 1.8.3"                ^
  ...
  rem --min-version
    call :checkTest                       ^
    "001-test\long-001\workspace\external\gtest\ver-1.11.x\gtest" ^
        "--names: gmock; gtest"           ^
        "--start:%list%"                  ^
        "--s: workspace*;external*;long*" ^
        "--min-version: 1.8.1"            ^
  ...
  rem --max-version
    call :checkTest                       ^
    "001-test\long-000\workspace\external\gmock\ver-1.10.x\gmock" ^
        "--names: gmock; gtest"           ^
        "--start:%list%"                  ^
        "--s: workspace*;external*;long*" ^
        "--max-version: 1.10.x"           ^
