...
:findProgram64
    set PATH_ARRAY[1]=%eDIR_WORKSPACE%\programs\x64\7-Zip
    set PATH_ARRAY[2]=C:\Program Files\7-Zip
    set PATH_ARRAY[3]=%eDIR_WORKSPACE%\programs\x86\7-Zip
    set PATH_ARRAY[4]=C:\Program Files (x86)\7-Zip
    set PATH_ARRAY[5]=...end...
    call :findProgram PATH_ARRAY eDIR_7Z 7z.exe
exit /b

:findProgram32
    set PATH_ARRAY[1]=%eDIR_WORKSPACE%\programs\x86\7-Zip
    set PATH_ARRAY[2]=C:\Program Files\7-Zip
